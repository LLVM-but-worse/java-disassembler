                        ...
                        if (decrypterclassnode != null)
                        {
                            ...
                            if (decryptermethodnode != null)
                            {
                                ...
                                try
                                {
                                    ...
                                    List<Class<?>> decrypterclasslist = the.bytecode.club.bytecodeviewer.api.BytecodeViewer.loadClassesIntoClassLoader(new ArrayList<ClassNode>(Arrays.asList(new ClassNode[] {
                                            decrypterclassnode })));
    ...
    private boolean scanDecrypter(MethodNode decryptermethodnode, int newHashCode)
    {
        ...
        for (AbstractInsnNode i : iList.toArray())
        {
            if (i instanceof MethodInsnNode)
            {
                ...
                { // find code form this instruction
                    insn = i;
                    break;
                }
