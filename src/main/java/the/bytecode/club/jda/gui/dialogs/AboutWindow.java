...
public class AboutWindow extends JFrame {
    ...
    public AboutWindow() {
        ...
        try {
            String text = IOUtils.toString(Resources.class.getResourceAsStream("/the/bytecode/club/jda/html/about.html"), "UTF-8");
            text = text.replace("$JDA_VERSION$", JDA.version + (JDA.previewCopy ? " (preview)" : ""));
            text = text.replace("$JDA_ICON$", Resources.class.getClass().getResource("/the/bytecode/club/jda/images/icon.png").toString());
